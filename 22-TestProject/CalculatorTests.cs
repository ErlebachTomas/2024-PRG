...
namespace _22_TestProject
{
    ...
    {
        private readonly Calculator _calc; // Instance testovan� t��dy
        ...
        /// <summary>
        /// Test: metoda Addition vrac� spr�vn� v�sledky
        /// </summary>
        [Fact]
        public void Addition_ShouldReturnCorrectResult()
        {
            Assert.Equal(2, _calc.Addition(1, 1));
            Assert.Equal(1.42, _calc.Addition(3.14, -1.72), 3);     // tolerance 3 desetinn� m�sta
